---
description: "Use when reviewing code, handling review feedback, or posting a review to a GitHub PR — 15-dimension quality analysis (with mandatory call-graph pre-analysis), structured feedback response, or automated PR review comment"
