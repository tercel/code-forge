...
**Quota-avoidance reminder.** Producing a finding because the dimension "feels under-utilized" is the failure mode §Finding Suppression Gate Gate 4 forbids. The orchestrator does NOT penalize empty dimensions; it auto-downgrades fabricated/speculative ones with visible markers. Quality of findings >> quantity of findings.
